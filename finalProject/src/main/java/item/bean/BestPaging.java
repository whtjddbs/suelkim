...
public class BestPaging {
	...
	public void makePagingHTML(String main_codename) {
		...
		if(startPage!=1)
			pagingHTML.append("[<a href='bestDisplay.do?main_codename="+main_codename+"&pg="+(startPage-1)+"'>이전</a>]");
		...
		if(endPage<totalP)
			pagingHTML.append("[<a href='bestDisplay.do?main_codename="+main_codename+"&pg="+(endPage+1)+"'>다음</a>]");
	}
}
